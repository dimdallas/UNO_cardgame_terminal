...
//        return cardList.isEmpty();
    ...
    public void playTurn() {
        boolean replay = tryPlayCard(cardsInHand.getValidCards(), true);

        // if draw card, replay
        if(replay){
            tryPlayCard(cardsInHand.getValidCards(), false);
        }
    }
...
//        displayCards(cardList);
        ...
        //check if valid card available
//        ArrayList<Card> validCards = cardValidator.getValidCards(cardsInHand);
